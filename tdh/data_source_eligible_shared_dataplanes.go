...
func (d *eligibleSharedDataplanesDatasource) convertToTfModel(ctx context.Context, dpDto model.EligibleSharedDataPlane, resp *datasource.ReadResponse) (dataplaneModel, bool) {
